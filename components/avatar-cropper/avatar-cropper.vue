    ...
    <view class="oper-wrapper" :style="{display: sD}">
      <view class="oper">
        <view class="btn-wrapper">
        	<view class="operateBtn" @click="fSelect" hover-class="hover" :style="{width: bW}"><text>重选</text></view>
        	<view class="operateBtn" @click="fClose" hover-class="hover" :style="{width: bW}"><text>关闭</text></view>
        	<!-- <view @click="fRotate" hover-class="hover" :style="{width: bW, display: bD}"><text>旋转</text></view> -->
        	<view class="operateBtn" @click="fPreview" hover-class="hover" :style="{width: bW}"><text>预览</text></view>
        	<view class="operateBtn" @click="fUpload" hover-class="hover" :style="{width: bW}"><text>完成</text></view>
        </view>
      </view>
    </view>
