...
(() => {
  ...
  // ../../../../../../Users/waner/Documents/Demos/uni_demo_vue3/unpackage/dist/dev/.nvue/platforms/app-plus/subNVue/appUpdate.js
  ...
  var requestUrl = "http://47.106.228.230:8080/yijie";
  var getToken = () => {
    try {
  ...
  function request(_0, _1) {
    return __async(this, arguments, function* (url, { data, method, requestType }) {
  ...
  function checkAndroidUpdate(data) {
    return __async(this, null, function* () {
      return request("/common/checkUpdate", { data });
    });
  }
  var useGlobalStore = (0, import_pinia.defineStore)("global", {
    state: () => ({
      apkInfo: {},
      haveNew: false
    }),
    actions: {
      checkAndroidUpdate(payload) {
        return __async(this, null, function* () {
          const response = yield checkAndroidUpdate(__spreadValues({}, payload));
          if (response.id) {
  ...
  var _sfc_main = {
    ...
    setup(__props) {
      ...
      const { apkInfo } = (0, import_pinia.storeToRefs)(globalStore);
      const downloading = (0, import_vue.ref)(false);
      ...
      return (_ctx, _cache) => {
        return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("scroll-view", {
          ...
          (0, import_vue.createElementVNode)("view", { class: "container" }, [
            (0, import_vue.createElementVNode)("view", { class: "updateWrap" }, [
              (0, import_vue.createElementVNode)("u-image", {
                class: "topIcon",
                mode: "widthFix",
                src: _imports_0
              }),
              (0, import_vue.createElementVNode)("view", { class: "updateContent" }, [
                (0, import_vue.createElementVNode)("u-text", { class: "updateTitleText" }, "\u68C0\u6D4B\u5230\u6709\u65B0\u7684\u7248\u672Cv." + (0, import_vue.toDisplayString)((0, import_vue.unref)(apkInfo).newVersion) + " \u662F\u5426\u66F4\u65B0\uFF1F", 1),
                (0, import_vue.createElementVNode)("u-text", { class: "updateDescText" }, (0, import_vue.toDisplayString)((0, import_vue.unref)(apkInfo).updateLog), 1),
                downloading.value ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(import_vue.Fragment, { key: 0 }, [
                  (0, import_vue.createVNode)((0, import_vue.unref)(progress), {
                    percent: progress.value,
                    "show-info": "",
                    class: "downloadProgress",
                    activeColor: "#E84339"
                  }, null, 8, ["percent"]),
                  (0, import_vue.createElementVNode)("u-text", { class: "downLoadText" }, "\u8D44\u6E90\u4E0B\u8F7D\u4E2D\uFF0C\u8BF7\u7A0D\u540E...")
                ], 64)) : ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("u-text", {
                  key: 1,
                  onClick: handleUpdate,
                  class: "updateBtnText"
                }, "\u7ACB\u5373\u5347\u7EA7"))
              ]),
              !(0, import_vue.unref)(apkInfo).isConstraint ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                key: 0,
                class: "line"
              })) : (0, import_vue.createCommentVNode)("v-if", true),
              !(0, import_vue.unref)(apkInfo).isConstraint ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("u-image", {
                key: 1,
                onClick: handleClose,
                class: "closeIcon",
                mode: "widthFix",
  ...
  var appUpdate = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]], ["__file", "/Users/waner/Documents/Demos/uni_demo_vue3/platforms/app-plus/subNVue/appUpdate.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "platforms/app-plus/subNVue/appUpdate";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    appUpdate.mpType = "page";
    const app = Vue.createPageApp(appUpdate, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...appUpdate.styles || []]));
    app.mount("#root");
  }
})();
/*!
